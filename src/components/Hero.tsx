  ...
  return (
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex justify-center mb-6">
          <div className="flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-blue-700 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center justify-center gap-12">
          ...
          <div className="w-full">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight drop-shadow-sm">
            ...
            <p className="text-xl md:text-2xl text-gray-800 mb-8 max-w-3xl mx-auto leading-relaxed font-semibold drop-shadow-sm">
            ...
            <div className="flex justify-center items-center mb-12">
              <button 
                ...
                className="group bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 hover:shadow-xl hover:scale-105 flex items-center space-x-2 shadow-lg"
              >
