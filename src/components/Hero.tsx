...
const Hero: React.FC<HeroProps> = ({ onJoinAsStudent }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            LaunchLink is the AI-powered platform that connects top university students with early-stage startups for high-impact freelance work. Think Fiverr, but for elite student talent.
          </p>
