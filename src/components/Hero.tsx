  ...
  return (
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex justify-center mb-6">
          <div className="flex items-center space-x-2 bg-blue-600/90 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center justify-center gap-12">
          ...
          <div className="w-full">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed font-medium drop-shadow-sm">
            ...
            <div className="flex justify-center items-center mb-12">
              <button 
                ...
                className="group bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:shadow-xl hover:scale-105 flex items-center space-x-2 shadow-lg"
              >
