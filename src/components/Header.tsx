    ...
    >
      ...
      >
        <div className="relative flex min-h-14 items-center justify-between px-6 py-2 sm:min-h-16 sm:px-8">
          ...
          <Link
            to={homePath}
            className={`relative z-10 flex shrink-0 items-center pointer-events-auto transition-[margin-top] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] ${
              isHeaderVisible ? 'mt-0' : 'mt-6'
            }`}
          ...
          >
            <img
              ...
              className={`object-contain object-left transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] ${
                isHeaderVisible
                  ? 'h-[18.8px] w-[81px] sm:h-[23.5px] sm:w-[101px]'
                  : 'h-[26.2px] w-[113px] sm:h-[32.8px] sm:w-[142px]'
              }`}
            />
          </Link>
